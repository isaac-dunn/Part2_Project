...
Met goals. Did extensions. Mostly correct.
Stuck to timetable.
Learnt lots, was interesting.

\section{Regrets}

\begin{itemize}
	\item SDPOR---ideally would have worked better
	\item SPOR---ideally would have time to do legit one
	\item locks---classic design error, should have thought in advance
\end{itemize}

\section{Extensions}
Read/write sensitivity.
Actual programming language.
Research, implement and compare more
recent developments.
