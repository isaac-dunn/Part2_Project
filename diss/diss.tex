...
of three explanations for this behaviour:
\begin{enumerate}
...
which suggests that the second reason is less likely.
...
just one of each) suggests that the third reason
is also less likely. This leaves only the first
reason, and while I can't see where my
misunderstanding is, I can accept that it is
the most probable explanation for the very poor
