...
There is no type system for PL. Although a type system
...
There are also various other auxiliary functions
...
ensure that operation each really is
...
\section{Dynamic Partial-Order Reduction}
An overview of the dynamic partial-order reduction (DPOR)
algorithm was presented in Section~\ref{sec:dpor-prep},
with a full explanation
given in Appendix~\ref{app:dpor-walkthrough}.
Several aspects of the algorithm mean that it
