...
A lot of the work that was necessary before
I began implementing the project was the
development of a firm understanding of an
area of computer science that was new to me,
particularly understanding the dynamic
partial-order reduction algorithm, and
therefore understanding precisely what
the finished project should do. Having
understood exactly what properties the
DPOR algorithm can check and reached the
above definition of model checking,
I set out to implement two algorithms
satisfying it: first, a simple
algorithm to check my understanding
of the basics, and then the DPOR
