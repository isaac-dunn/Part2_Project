...
\begin{enumerate}
	\item the simplest program imaginable, where
...
very quick executions. The precision of measurements seems
...
\begin{itemize}
	\item How well does DPOR do at reducing state space?
	\item What difference do sleep sets make?
	\item How does SDPOR compare to DPOR, compared with
	simple compared with simple stateful? Number of states?
	\item How does execution time relate to transitions explored?
	Interplay between number of calls and time per call.
	(Graph of time/call?)
	\item How do my implementations of DPOR/SDPOR compare to published
	results?
