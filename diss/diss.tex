...
\begin{understandinglist}
	...
	\textbf{my project is correct CLARIFY}, and the evidence
...
is about 1 to 25 errors per 1,000 lines \textbf{QUOTE MARKS FOR DIRECT QUOTATION}
...
I wrote over forty \textbf{ACTUAL NUMBER}varied test cases, each
...
\textbf{I used my confidence in the simple
...
read \cite{demi79}. \textbf{Make clear someone else claims this}
...
reducing the \textbf{size of the state
...
\textbf{MOVE TO METHODOLOGY \& explain WHY examples chosen}
...
\textbf{Mention algorithms performance}
