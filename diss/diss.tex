...
finite sequence of \emph{invisible} (i.e. entirely local)
operations, followed by one \emph{visible} (i.e. accesses
the shared store) operation, the \texttt{next\char`_transition}
