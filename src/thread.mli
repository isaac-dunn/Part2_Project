...
type thread_step = { new_expr : Expression.expr ;
...
type thread_transition = { next_expr : Expression.expr ;
...
val next_step : Expression.expr * Store.store * Store.store -> thread_step option
...
val next_transition : Expression.expr * Store.store * Store.store -> thread_transition option
